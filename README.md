...
<b>Поиск в ширину (BFS)</b> — это алгоритм обхода или поиска в графе, который начинается с произвольной стартовой вершины и исследует все её соседние вершины перед переходом к вершинам следующего уровня. 
